class LanguageScreen {
    ...
    static init() {
        ...
        let frBtn = new Button({ w: 54, h: 20, v: 4 }, centerX(54), 80, { cb: LanguageScreen.changeLanguage, arg: "fr" }, "LanguageScreen", LanguageScreen.STATE.Main, "hiragana");
        //frBtn.setTextCase("all");
        LanguageScreen.list.push(frBtn.getSprite());
        let testPanel = new Panel({ w: 100, h: 120, v: 5 }, centerX(100, 80, 1), 60, null, "LanguageScreen", LanguageScreen.STATE.Main, "hira", 1);
        let test2Panel = new Panel({ w: 100, h: 120, v: 1 }, centerX(100, 80, 1), 80, null, "LanguageScreen", LanguageScreen.STATE.Main, "text1", 2);
        ...
        frBtn.setTooltip(test2Panel);
        // frBtn.setTooltip(hiraAnim);
        frBtn.setHoverCB(displayTooltip, { list: "LanguageScreen", tooltip: frBtn.getTooltip() });

        let enBtn = new Button({ w: 54, h: 20, v: 4 }, centerX(54), 110, { cb: LanguageScreen.changeLanguage, arg: "en" }, "LanguageScreen", LanguageScreen.STATE.Main, "katakana");
        //enBtn.setTextCase("all");
        LanguageScreen.list.push(enBtn.getSprite());
        let test3Panel = new Panel({ w: 100, h: 120, v: 5 }, centerX(100, 80, 1), 70, null, "LanguageScreen", LanguageScreen.STATE.Main, "kata", 1);
        let test4Panel = new Panel({ w: 100, h: 120, v: 1 }, centerX(100, 80, 1), 90, null, "LanguageScreen", LanguageScreen.STATE.Main, "text2", 2);
        enBtn.setTooltip(test3Panel);
        enBtn.setTooltip(test4Panel);
        enBtn.setHoverCB(displayTooltip, { list: "LanguageScreen", tooltip: enBtn.getTooltip() });


        let jpBtn = new Button({ w: 54, h: 20, v: 4 }, centerX(54), 140, { cb: LanguageScreen.changeLanguage, arg: "jp" }, "LanguageScreen", LanguageScreen.STATE.Main, "kanji");
        //jpBtn.setTextCase("all"); // TO DELETE

        LanguageScreen.list.push(jpBtn.getSprite());

        let test5Panel = new Panel({ w: 100, h: 120, v: 5 }, centerX(100, 80, 1), 80, null, "LanguageScreen", LanguageScreen.STATE.Main, "kan", 1);
        let test6Panel = new Panel({ w: 100, h: 120, v: 1 }, centerX(100, 80, 1), 100, null, "LanguageScreen", LanguageScreen.STATE.Main, "text3", 2);
        jpBtn.setTooltip(test5Panel);
        jpBtn.setTooltip(test6Panel);
        jpBtn.setHoverCB(displayTooltip, { list: "LanguageScreen", tooltip: jpBtn.getTooltip() });



        let changeLangFr = new Button({ w: 54, h: 20, v: 4 }, centerX(54, 80), 80, { cb: LanguageScreen.changeLanguage, arg: "fr" }, "LanguageScreen", LanguageScreen.STATE.Main, "french_lang");
        LanguageScreen.list.push(changeLangFr.getSprite());
        let changeLangEn = new Button({ w: 54, h: 20, v: 4 }, centerX(54, 80), 120, { cb: LanguageScreen.changeLanguage, arg: "en" }, "LanguageScreen", LanguageScreen.STATE.Main, "english_lang");
        LanguageScreen.list.push(changeLangEn.getSprite());
        ...
        let test7Panel = new Panel({ w: 100, h: 20, v: 5 }, centerX(60), 50, null, "LanguageScreen", LanguageScreen.STATE.Main, "start", 1);
        LanguageScreen.list.push(test7Panel.getSprite());
